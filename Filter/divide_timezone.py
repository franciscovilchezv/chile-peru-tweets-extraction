...
ARCHIVO_SALIDA_PERU = '../files/output_timezone_lima.json'
ARCHIVO_SALIDA_CHILE = '../files/output_timezone_santiago.json'
ARCHIVO_SALIDA_OTHER = '../files/output_timezone_null.json'
#ARCHIVO_SALIDA_NO_LOCATION = '../files/output_null.json'

ARCHIVOS_ENTRADA = [
    "../files/output_no_location_noRT.json"
]
    ...
    for in_file in ARCHIVOS_ENTRADA:
        ...
        for line in lines:
            ...
            try:
                ...
                if var_json["user"]["time_zone"] == "Lima":
                    output_peru.write(to_JSON(var_json))
                    count_location_PER += 1
                elif var_json["user"]["time_zone"] == "Santiago":
